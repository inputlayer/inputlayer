#!/usr/bin/env python3
"""Preprocess an .idl file: strip comments and join multi-line statements.
...
Usage: python3 preprocess-idl.py <input.idl>
"""
import sys

def main():
    if len(sys.argv) < 2:
        print("Usage: preprocess-idl.py <input.idl>", file=sys.stderr)
        sys.exit(1)
