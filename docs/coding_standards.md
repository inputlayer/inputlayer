# InputLayer Coding Standards & Principles

> **Project Status**: Pre-Alpha
>
> We are in active development with no external users yet. This means:
...
> - Delete deprecated code immediately rather than maintaining it
...
pub type Tuple2 = (i32, i32);  // Legacy
pub struct Tuple(Vec<Value>);  // New

fn execute_old(...) -> Vec<Tuple2> { ... }  // Keep for compatibility?
...
│   ├── mod.rs
│   └── builders.rs     # Builder patterns for AST construction
...
5. Add snapshot test in `examples/datalog/`
...
4. Add IR handling in `src/ir_builder/mod.rs`
5. Add code generation in `src/code_generator/mod.rs`
6. Add tests
