...
This section describes the complete syntax of InputLayer IQL.
...
Statements do not require a trailing period (unlike traditional Prolog/IQL).
...
- **[Rules](rules.md)** - Session and persistent rules
- **[Queries](queries.md)** - Querying data
- **[Types](types.md)** - Integers, strings, floats, vectors
...
InputLayer extends standard IQL with:
