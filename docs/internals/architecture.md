...
**Test Coverage**: 1567 unit tests + 1109 snapshot tests, all passing (as of 2026-02-08).
...
|-------------|--------|-------------|
| Abomonation fix | ✅ | Proper exhume() for multi-worker DD |
| Generic timestamps | ✅ | CodeGenerator uses `G::Timestamp: Lattice + Ord + Default` |
| DDComputation | ✅ | Persistent incremental computation |
| Insert path wiring | ✅ | Shadow writes to DDComputation |
| Consistent reads | ✅ | Lazy time advancement + frontier tracking |
| Rule materialization | ✅ | DerivedRelationsManager with validity tracking |
| Auto-materialization | ✅ | Persistent rules auto-materialize |
| Session isolation | ✅ | Cloned snapshots for session facts |
