...
InputLayer supports record types as a way to document the structure of data. Currently, record types serve as documentation; the desugaring features described here are planned for future implementation.
