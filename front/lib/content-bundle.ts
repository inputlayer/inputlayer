...
export const blogPosts: BlogPost[] = [
  {
    ...
    "toc": [
      ...
      {
        "level": 2,
        "text": "The proof tree: explainable memory",
        "id": "the-proof-tree-explainable-memory"
      },
      {
        "level": 2,
        "text": "Code: adding memory to a LangGraph agent",
        "id": "code-adding-memory-to-a-langgraph-agent"
      },
      {
        "level": 2,
