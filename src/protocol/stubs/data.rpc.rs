...
//!
//! RPC service definition for data manipulation operations.
//!
//! Generate code with:
//! ```bash
...
pub trait DataService {
    ...
    /// Bulk insert with client streaming.
    #[rpcnet::client_streaming]
    async fn bulk_insert(&self, batches: InsertBatch) -> Result<BulkInsertResponse, DataError>;

    /// Get the schema of a relation.
    async fn get_schema(&self, request: GetSchemaRequest) -> Result<GetSchemaResponse, DataError>;
}
