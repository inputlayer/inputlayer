...
export const docsPages: Record<string, DocPage> = {
  ...
  "guides/langchain": {
    ...
    "toc": [
      ...
      {
        "level": 2,
        "text": "Quick Start: Vector store + retriever",
        "id": "quick-start-vector-store-retriever"
      },
      {
        "level": 3,
      ...
      {
        "level": 2,
        "text": "IQL retriever for joins and rules",
        "id": "iql-retriever-for-joins-and-rules"
      },
      {
        "level": 3,
        "text": "Vector mode",
      ...
      {
        "level": 2,
        "text": "Structured tools from relations",
        "id": "structured-tools-from-relations"
      },
      {
        "level": 2,
        "text": "Raw IQL tool",
  ...
  "guides/migrations": {
    ...
    "toc": [
      ...
      {
        "level": 3,
        "text": "il makemigrations",
        "id": "il-makemigrations"
      },
      {
        "level": 3,
        "text": "il migrate",
