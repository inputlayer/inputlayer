...
export const docsNavigation: NavItem[] = [
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "key": "verified-completions",
        "label": "Verified Completions",
        "slug": "guides/verified-completions",
        "href": "/docs/guides/verified-completions",
        "children": []
      },
      {
        "key": "core-concepts",
      ...
      },
      {
        ...
        "slug": "guides/explainability",
        "href": "/docs/guides/explainability",
        "children": []
      },
      {
        "key": "query-profiling",
      ...
      },
      {
        ...
        "slug": "guides/langchain",
        "href": "/docs/guides/langchain",
        "children": []
      },
      {
        "key": "langgraph",
        "label": "LangGraph Integration",
        "slug": "guides/langgraph",
        "href": "/docs/guides/langgraph",
        "children": []
      },
      {
        "key": "js-sdk",
...
export const docsPages: Record<string, DocPage> = {
  ...
  "guides/explainability": {
    ...
    "toc": [
      ...
      {
        "level": 2,
        "text": "Negative Explanations with .whynot",
        "id": "negative-explanations-with-whynot"
      },
      {
        "level": 2,
        "text": "SDK Usage",
  ...
  "guides/langchain": {
    ...
    "toc": [
      ...
      {
        "level": 2,
        "text": "Part 1: Vector store basics",
        "id": "part-1-vector-store-basics"
      },
      {
        "level": 3,
      ...
      {
        "level": 3,
        "text": "Creating the store and adding documents",
        "id": "creating-the-store-and-adding-documents"
      },
      {
        "level": 3,
        "text": "Plugging into a chain",
        "id": "plugging-into-a-chain"
      },
      {
        "level": 3,
        "text": "Filtering by metadata",
        "id": "filtering-by-metadata"
      },
      {
        "level": 3,
        "text": "Diversity with MMR",
        "id": "diversity-with-mmr"
      },
      {
        "level": 3,
      ...
      {
        "level": 2,
        "text": "Part 2: Retrieval with structure",
        "id": "part-2-retrieval-with-structure"
      },
      {
        "level": 3,
        "text": "Your first IQL retriever",
        "id": "your-first-iql-retriever"
      },
      {
        "level": 3,
      ...
      {
        "level": 3,
        "text": "Vector mode on the retriever",
        "id": "vector-mode-on-the-retriever"
      },
      {
        "level": 2,
        "text": "Part 3: Giving tools to an agent",
        "id": "part-3-giving-tools-to-an-agent"
      },
      {
        "level": 3,
        "text": "Raw IQL tool (escape hatch)",
        "id": "raw-iql-tool-escape-hatch"
      },
      {
        "level": 2,
        "text": "Part 4: Reasoning-powered retrieval",
        "id": "part-4-reasoning-powered-retrieval"
      },
      {
        "level": 3,
      ...
      {
        "level": 3,
        "text": "Explainability with .why()",
        "id": "explainability-with-why"
      },
      {
        "level": 3,
  ...
  "guides/langgraph": {
    ...
    "toc": [
      ...
      {
        "level": 2,
        "text": "Part 1: Rules-driven routing",
        "id": "part-1-rules-driven-routing"
      },
      {
        "level": 3,
        "text": "State that carries the KG",
        "id": "state-that-carries-the-kg"
      },
      {
        "level": 3,
        "text": "Query nodes with kgnode",
        "id": "query-nodes-with-kgnode"
      },
      {
        "level": 3,
        "text": "Rules-driven routing with kgrouter",
        "id": "rules-driven-routing-with-kgrouter"
      },
      {
        "level": 3,
      ...
      {
        "level": 2,
        "text": "Part 2: Resumable graphs with InputLayerCheckpointer",
        "id": "part-2-resumable-graphs-with-inputlayercheckpointer"
      },
      {
        "level": 3,
        "text": "Why persist to a KG",
        "id": "why-persist-to-a-kg"
      },
      {
        "level": 3,
        "text": "Basic use",
      ...
      {
        "level": 3,
        "text": "Migrating from another checkpointer",
        "id": "migrating-from-another-checkpointer"
      },
      {
        "level": 3,
        "text": "Concurrency",
      ...
      {
        "level": 2,
        "text": "Part 3: Semantic memory with InputLayerMemory",
        "id": "part-3-semantic-memory-with-inputlayermemory"
      },
      {
        "level": 3,
        "text": "The base schema",
        "id": "the-base-schema"
      },
      {
        "level": 3,
        "text": "Storing and recalling",
        "id": "storing-and-recalling"
      },
      {
        "level": 3,
        "text": "Wiring into a graph",
        "id": "wiring-into-a-graph"
      },
      {
        "level": 3,
        "text": "Extending the ontology",
        "id": "extending-the-ontology"
      },
      {
        "level": 3,
        "text": "Production note on topic extraction",
        "id": "production-note-on-topic-extraction"
      },
      {
        "level": 3,
        "text": "Listing stored conversations",
        "id": "listing-stored-conversations"
      },
      {
        "level": 2,
        "text": "Combining the checkpointer and memory in one graph",
        "id": "combining-the-checkpointer-and-memory-in-one-graph"
      },
      {
        "level": 2,
        "text": "Safe parameter binding",
  ...
  "guides/migrations": {
    ...
    "toc": [
      ...
      {
        "level": 3,
        "text": "1. Define Your Models",
        "id": "1-define-your-models"
      },
      {
        "level": 3,
        "text": "2. Generate the Initial Migration",
        "id": "2-generate-the-initial-migration"
      },
      {
        "level": 3,
        "text": "3. Apply the Migration",
        "id": "3-apply-the-migration"
      },
      {
        "level": 3,
        "text": "4. Make Changes and Iterate",
        "id": "4-make-changes-and-iterate"
      },
      {
        "level": 3,
        "text": "5. Check Status",
      ...
      {
        "level": 3,
        "text": "il migration generate",
        "id": "il-migration-generate"
      },
      {
        "level": 3,
        "text": "il migration apply",
        "id": "il-migration-apply"
      },
      {
        "level": 3,
        "text": "il migration revert",
        "id": "il-migration-revert"
      },
      {
        "level": 3,
        "text": "il migration status",
        "id": "il-migration-status"
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "text": "How the Autodetector Works",
        "id": "how-the-autodetector-works"
      },
      {
        "level": 2,
        "text": "Applied Migration Tracking",
        "id": "applied-migration-tracking"
      },
      {
        "level": 2,
      ...
      {
        "level": 3,
        "text": "Naming Migrations",
        "id": "naming-migrations"
      },
      {
        "level": 2,
  ...
  "guides/python-sdk": {
    ...
    "toc": [
      ...
      {
        "level": 3,
        "text": "Inserting from pandas DataFrames",
        "id": "inserting-from-pandas-dataframes"
      },
      {
        "level": 2,
        "text": "Deleting Data",
  ...
  "guides/verified-completions": {
    ...
    "toc": [
      ...
      {
        "level": 2,
        "text": "1. Install an ontology into a knowledge graph",
        "id": "1-install-an-ontology-into-a-knowledge-graph"
      },
      {
        "level": 2,
        "text": "2. Chat - and let evaluation happen",
        "id": "2-chat-and-let-evaluation-happen"
      },
      {
        "level": 2,
        "text": "3. Watch a conversation live",
        "id": "3-watch-a-conversation-live"
      },
      {
        "level": 2,
        "text": "4. Enforce - and fail closed",
        "id": "4-enforce-and-fail-closed"
      },
      {
        "level": 2,
  ...
  "reference/commands": {
    ...
    "toc": [
      ...
      {
        "level": 3,
        "text": ".whynot <relation>(<values>)",
        "id": "whynot-relationvalues"
      },
      {
        "level": 3,
        "text": ".compact",
