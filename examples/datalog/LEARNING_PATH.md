...
|---------|-------------------|
| `01_knowledge_graph/01_create_use_drop.dl` | Creating, switching, and dropping knowledge graphs |
| `01_knowledge_graph/02_list_kg.dl` | Listing knowledge graphs |
...
| `06_joins/04_multi_join.dl` | Three or more relations |
| `06_joins/08_join_with_constants.dl` | Mixing variables and constants |
| `06_joins/07_cross_product.dl` | Cross products (careful!) |
...
| `07_filters/12_less_than.dl` | Less-than comparisons |
| `07_filters/11_greater_than.dl` | Greater-than comparisons |
...
| `08_negation/02_negation_with_join.dl` | Negation combined with joins |
...
| `09_recursion/05_left_recursion.dl` | Left-recursive style |
| `09_recursion/29_right_linear.dl` | Right-recursive style |
...
| Example | What You'll Learn |
|---------|-------------------|
| `09_recursion/08_mutual_recursion.dl` | Rules that reference each other |
| `09_recursion/06_deep_recursion_100.dl` | Long recursive chains |
| `09_recursion/17_linear_recursion.dl` | Linear recursion patterns |
...
| `09_recursion/10_multiple_base_cases.dl` | Multiple base cases |
...
| `11_types/03_floats_truncation.dl` | Float values and truncation |
| `11_types/05_mixed_type_tuples.dl` | Combining types |

### 8.2 Schema Declarations

| Example | What You'll Learn |
|---------|-------------------|
| `24_rel_schemas/01_explicit_schema.dl` | Basic schema |
| `24_rel_schemas/02_record_schema_sugar.dl` | Schema with record syntax |
...
| Example | What You'll Learn |
|---------|-------------------|
| `20_applications/01_rbac_permissions.dl` | Role-based access control |
| `20_applications/03_friends_of_friends.dl` | Social network analysis |
| `20_applications/05_bom_explosion.dl` | Bill-of-materials / supply chain |
| `20_applications/07_package_deps.dl` | Dependency resolution |
| `20_applications/10_common_ancestor.dl` | Common ancestor computation |

### 10.2 Query Features

| Example | What You'll Learn |
|---------|-------------------|
| `21_query_features/01_distinct_results.dl` | Distinct results |
...
| Example | What You'll Learn |
|---------|-------------------|
| `22_set_operations/01_implicit_union.dl` | Union of relations |
| `22_set_operations/03_intersection.dl` | Intersection |
| `22_set_operations/04_set_difference.dl` | Set difference |
...
| `10_edge_cases/03_duplicates.dl` | Duplicate handling |
| `10_edge_cases/02_self_loop.dl` | Self-referential edges |

### 11.2 Error Examples

| Example | What You'll Learn |
|---------|-------------------|
| `12_errors/01_undefined_relation.dl` | Unknown relation errors |
| `12_errors/02_invalid_syntax_error.dl` | Syntax errors |
| `12_errors/03_duplicate_kg_error.dl` | Duplicate knowledge graph errors |
| `12_errors/04_arity_mismatch_error.dl` | Wrong number of columns |
| `12_errors/05_drop_nonexistent_db_error.dl` | Knowledge graph errors |
...
4. **Understand recursion deeply**  - it's what sets Datalog apart
